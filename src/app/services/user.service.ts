...
export class UserService {
	...
	update(id: number, nome: string, sobrenome: string, contato: string, username: string, password:string) {
        const usuario = { id: id, nome: nome, sobrenome: sobrenome,contato: contato, username:username, password:password };
